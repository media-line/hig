...
<div class="jshop productfull" id="comjshop">
    <form class="clearfix" name="product" method="post" action="<?php print $this->action?>" enctype="multipart/form-data" autocomplete="off">
		...
		<div class="joomshopping_menu joomshopping_full_block">
			<?php jimport( 'joomla.application.module.helper' ); 
			$module = JModuleHelper::getModules('joomshopping_menu'); 
			$attribs['style'] = 'xhtml'; 
			echo JModuleHelper::renderModule($module[0], $attribs); ?>
		</div>
		
        <div class="joomshopping_full_block joomshopping_full_product">	
	...
	<?php jimport( 'joomla.application.module.helper' ); 
	$module = JModuleHelper::getModules('after_product'); 
	$attribs['style'] = 'xhtml'; 
	echo JModuleHelper::renderModule($module[0], $attribs); ?> 
