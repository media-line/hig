...
<div class="jshop" id="comjshop">
	<?php if (JRequest::getVar('category_id') != 7) { ?>
	...
	<div class="joomshopping_category clearfix">
		...
		<?php if ($this->category->category_parent_id == 0) { ?>
						...
						<div class = "sblock<?php echo $this->count_category_to_row;?> jshop_categ jshop_categ_<?php echo $k;?> category">
							...
							<div class="sblock2 content clearfix">
								<div class="sblock2_inner products">
									...
									<?php $subCats = $cat->getSubCategories($category->category_id);
									foreach ($subCats as $subCat) { ?>
										<a class="subCatLink" href="<?php echo $subCat->category_link; ?>"><?php echo $subCat->name; ?></a><br>
									<?php } ?>							
								</div>
        ...
        <?php include(dirname(__FILE__)."/products_units.php");?>
