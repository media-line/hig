...
<div class="jshop" id="comjshop">
    ...
    <div class="div_h1"><?php print $this->manufacturer->name?></div>   
	
    <div class="manufacturer_description">
	    <?php print $this->manufacturer->short_description;?>
    ...
    <?php
        ...
        if (count($this->rows)){
            include(dirname(__FILE__)."/../list_products/list_products_object.php");
        }else{
