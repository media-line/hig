...
<?php if ($this->params->get('show_page_heading') && $this->params->get('page_heading')) : ?>    
    <div class="shophead<?php print $this->params->get('pageclass_sfx');?>">
        <div class="div_h1"><?php print $this->params->get('page_heading')?></div>
    </div>
<?php endif; ?>
        ...
        <div class = "jshop">
            <?php foreach($this->rows as $k=>$row) : ?>
                ...
                <div class = "sblock<?php echo $this->count_manufacturer_to_row?> jshop_categ manufacturer">
					<div class="manufacture_block_inner clearfix"> 
						<div class = "sblock2 manufacture_block image">
						...
						<div class = "sblock2 manufacture_block info">
							...
							<?php endif; ?>
							<div class="manufacture_more">Подробнее</div>
							<a href="/ob-ekty?manufacturer_id=<?php echo $row->manufacturer_id; ?>" class="manufacture_object">Посмотреть объекты</a>
						</div>
					</div>
                </div>
