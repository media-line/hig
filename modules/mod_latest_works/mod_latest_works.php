	...
	<div class="clearfix">
		<div class="mod_latest_works_block clearfix">
		    <div class="mod_latest_works_block_border clearfix">
				...
				<div class="mod_latest_works_block_inner image" style="background-image: url('<?php echo $params->get('logo1'); ?>'); "></div>
			</div>
		    <div class="mod_latest_works_block_border clearfix">
				<div class="mod_latest_works_block_inner text">
				...
				<div class="mod_latest_works_block_inner image" style="background-image: url('<?php echo $params->get('logo2'); ?>'); "></div>
			</div>
		</div>
		<div class="mod_latest_works_block clearfix">
		    <div class="mod_latest_works_block_border clearfix">
				<div class="mod_latest_works_block_inner text">
					<div class="name"><?php echo $params->get('name3'); ?></div>
					<div class="text"><?php echo $params->get('text3'); ?></div>
				</div>
				<div class="mod_latest_works_block_inner image" style="background-image: url('<?php echo $params->get('logo3'); ?>'); "></div>
			</div>
		    <div class="mod_latest_works_block_border clearfix">
				<div class="mod_latest_works_block_inner text">
					<div class="name"><?php echo $params->get('name4'); ?></div>
					<div class="text"><?php echo $params->get('text4'); ?></div>
				</div>
				<div class="mod_latest_works_block_inner image" style="background-image: url('<?php echo $params->get('logo4'); ?>'); "></div>
			</div>
		</div>
		<!--<div class="mod_latest_works_block narrow">
		    <div class="mod_latest_works_block_border clearfix">
				<div class="mod_latest_works_block_inner text">
					<div class="name"><?php echo $params->get('name5'); ?></div>
