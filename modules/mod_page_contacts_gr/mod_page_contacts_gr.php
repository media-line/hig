...
<div class="clearfix mod_contacts_page" itemscope itemtype="http://schema.org/Organization">
    ...
    <a href="<?php echo $params->get('info_link'); ?>" class="button_doc">
        <div class="word"><img src="/images/word.png"></div>
        Реквизиты</a>
    <div class="wrap_contacts_page_block">
            ...
            <?php for ($i = 0; $i < $count; $i++) { ?>
                <div class="mod_contacts_page_block_map clearfix">
                    ...
                    <div class="map_block map">
                        <p><span itemprop="addressLocality"><?php echo $mapTextCityArr[$i]; ?></span>, <span
                                    itemprop="streetAddress"><?php echo $mapTextStreetArr[$i]; ?></span></p>
                        <p class="map_button button_<?php echo $i; ?>" data="<?php echo $i; ?>"
                        <!--data-toggle="modal" data-target=".map_modal_<?php echo $i; ?>"-->Посмотреть карту
                        проезда</p>
                    </div>
                </div>
                ...
                <div class="mod_contacts_page_block_single clearfix">
                    <div class="map_block logo">
                        ...
                        <?php } else if ($mapActive1Arr[$i] == 'skype') { ?>
                            <a href="skype:<?php echo $mapActive1UrlArr[$i]; ?>?chat"><img
                                        src="<?php echo $mapBlock1LogoArr[$i]; ?>" alt=""></a>
                        <?php } else if ($mapActive1Arr[$i] == 'viber') { ?>
                            <a href="viber://chat:<?php echo $mapActive1UrlArr[$i]; ?>"><img
                                        src="<?php echo $mapBlock1LogoArr[$i]; ?>" alt=""></a>
                        <?php } else if ($mapActive1Arr[$i] == 'mail') { ?>
                            <a href="mailto:<?php echo $mapActive1UrlArr[$i]; ?>"><img
                                        src="<?php echo $mapBlock1LogoArr[$i]; ?>" alt=""></a>
                        <?php } else { ?>
                            <img src="<?php echo $mapBlock1LogoArr[$i]; ?>" alt="">
                        <?php } ?>
                    ...
                    <div class="map_block map">
                        ...
                        <?php } else if ($mapActive1Arr[$i] == 'skype') { ?>
                            <p>
                                <a href="skype:<?php echo $mapActive1UrlArr[$i]; ?>?chat"><?php echo createBold($mapBlock1InfoArr[$i]); ?></a>
                            </p>
                        <?php } else if ($mapActive1Arr[$i] == 'viber') { ?>
                            <p>
                                <a href="viber://chat:<?php echo $mapActive1UrlArr[$i]; ?>"><?php echo createBold($mapBlock1InfoArr[$i]); ?></a>
                            </p>
                        <?php } else { ?>
                ...
                <div class="mod_contacts_page_block_single clearfix">
                    <div class="map_block logo">
                        ...
                        <?php } else if ($mapActive2Arr[$i] == 'skype') { ?>
                            <a href="skype:<?php echo $mapActive2UrlArr[$i]; ?>?chat"><img
                                        src="<?php echo $mapBlock2LogoArr[$i]; ?>" alt=""></a>
                        <?php } else if ($mapActive2Arr[$i] == 'viber') { ?>
                            <a href="viber://chat:<?php echo $mapActive2UrlArr[$i]; ?>"><img
                                        src="<?php echo $mapBlock2LogoArr[$i]; ?>" alt=""></a>
                        <?php } else if ($mapActive2Arr[$i] == 'mail') { ?>
                            <a href="mailto:<?php echo $mapActive2UrlArr[$i]; ?>"><img
                                        src="<?php echo $mapBlock2LogoArr[$i]; ?>" alt=""></a>
                        <?php } else { ?>
                            <img src="<?php echo $mapBlock2LogoArr[$i]; ?>" alt="">
                        <?php } ?>
                    ...
                    <div class="map_block map">
                        ...
                        <?php } else if ($mapActive2Arr[$i] == 'skype') { ?>
                            <p>
                                <a href="skype:<?php echo $mapActive2UrlArr[$i]; ?>?chat"><?php echo createBold($mapBlock2InfoArr[$i]); ?></a>
                            </p>
                        <?php } else if ($mapActive2Arr[$i] == 'viber') { ?>
                            <p>
                                <a href="viber://chat:<?php echo $mapActive2UrlArr[$i]; ?>"><?php echo createBold($mapBlock2InfoArr[$i]); ?></a>
                            </p>
                        <?php } else { ?>
                            <p><?php echo createBold($mapBlock2InfoArr[$i]); ?></p>
                        <?php } ?>
                ...
                <div class="mod_contacts_page_block_single clearfix">
                    <div class="map_block logo">
                        ...
                        <?php } else if ($mapActive3Arr[$i] == 'skype') { ?>
                            <a href="skype:<?php echo $mapActive3UrlArr[$i]; ?>?chat"><img
                                        src="<?php echo $mapBlock3LogoArr[$i]; ?>" alt=""></a>
                        <?php } else if ($mapActive3Arr[$i] == 'viber') { ?>
                            <a href="viber://chat:<?php echo $mapActive3UrlArr[$i]; ?>"><img
                                        src="<?php echo $mapBlock3LogoArr[$i]; ?>" alt=""></a>
                        <?php } else if ($mapActive3Arr[$i] == 'mail') { ?>
                            <a href="mailto:<?php echo $mapActive3UrlArr[$i]; ?>"><img
                                        src="<?php echo $mapBlock3LogoArr[$i]; ?>" alt=""></a>
                        <?php } else { ?>
                            <img src="<?php echo $mapBlock3LogoArr[$i]; ?>" alt="">
                        <?php } ?>
                    ...
                    <div class="map_block map">
                        ...
                        <?php } else if ($mapActive3Arr[$i] == 'skype') { ?>
                            <p>
                                <a href="skype:<?php echo $mapActive3UrlArr[$i]; ?>?chat"><?php echo createBold($mapBlock3InfoArr[$i]); ?></a>
                            </p>
                        <?php } else if ($mapActive3Arr[$i] == 'viber') { ?>
                            <p>
                                <a href="viber://chat:<?php echo $mapActive3UrlArr[$i]; ?>"><?php echo createBold($mapBlock3InfoArr[$i]); ?></a>
                            </p>
                        <?php } else { ?>
                            <p><?php echo createBold($mapBlock3InfoArr[$i]); ?></p>
                        <?php } ?>
                            ...
                            <?php if (!empty($employee1info1Arr[$i])) { ?>
                                <div class="clearfix">
                                    <?php if ($employee1logo1Arr[$i]) { ?>
                                        <div class="employee_block logo"><img
                                                    src="<?php echo $employee1logo1Arr[$i]; ?>" alt=""></div>
                                    <?php } ?>
                            ...
                            <?php if (!empty($employee1info2Arr[$i])) { ?>
                                <div class="clearfix">
                                    <?php if ($employee1logo2Arr[$i]) { ?>
                                        <div class="employee_block logo"><img
                                                    src="<?php echo $employee1logo2Arr[$i]; ?>" alt=""></div>
                                    <?php } ?>
                                    <div class="employee_block info">
                            ...
                            <?php if (!empty($employee1info3Arr[$i])) { ?>
                                <div class="clearfix">
                                    <?php if ($employee1logo3Arr[$i]) { ?>
                                        <div class="employee_block logo"><img
                                                    src="<?php echo $employee1logo3Arr[$i]; ?>" alt=""></div>
                                    <?php } ?>
                                    <div class="employee_block info">
                            ...
                            <?php if (!empty($employee2info1Arr[$i])) { ?>
                                <div class="clearfix">
                                    <?php if ($employee2logo1Arr[$i]) { ?>
                                        <div class="employee_block logo"><img
                                                    src="<?php echo $employee2logo1Arr[$i]; ?>" alt=""></div>
                                    <?php } ?>
                                    <div class="employee_block info">
                            ...
                            <?php if (!empty($employee2info2Arr[$i])) { ?>
                                <div class="clearfix">
                                    <?php if ($employee2logo2Arr[$i]) { ?>
                                        <div class="employee_block logo"><img
                                                    src="<?php echo $employee2logo2Arr[$i]; ?>" alt=""></div>
                                    <?php } ?>
                                    <div class="employee_block info">
                            ...
                            <?php if (!empty($employee2info3Arr[$i])) { ?>
                                <div class="clearfix">
                                    <?php if ($employee2logo3Arr[$i]) { ?>
                                        <div class="employee_block logo"><img
                                                    src="<?php echo $employee2logo3Arr[$i]; ?>" alt=""></div>
                                    <?php } ?>
                                    <div class="employee_block info">
                            ...
                            <?php if (!empty($employee3info1Arr[$i])) { ?>
                                <div class="clearfix">
                                    <?php if ($employee3logo1Arr[$i]) { ?>
                                        <div class="employee_block logo"><img
                                                    src="<?php echo $employee3logo1Arr[$i]; ?>" alt=""></div>
                                    <?php } ?>
                                    <div class="employee_block info">
                            ...
                            <?php if (!empty($employee3info2Arr[$i])) { ?>
                                <div class="clearfix">
                                    <?php if ($employee3logo2Arr[$i]) { ?>
                                        <div class="employee_block logo"><img
                                                    src="<?php echo $employee3logo2Arr[$i]; ?>" alt=""></div>
                                    <?php } ?>
                                    <div class="employee_block info">
                            ...
                            <?php if (!empty($employee3info3Arr[$i])) { ?>
                                <div class="clearfix">
                                    <?php if ($employee3logo3Arr[$i]) { ?>
                                        <div class="employee_block logo"><img
                                                    src="<?php echo $employee3logo3Arr[$i]; ?>" alt=""></div>
                                    <?php } ?>
                                    <div class="employee_block info">
                            ...
                            <?php if (!empty($employee4info1Arr[$i])) { ?>
                                <div class="clearfix">
                                    <?php if ($employee4logo1Arr[$i]) { ?>
                                        <div class="employee_block logo"><img
                                                    src="<?php echo $employee4logo1Arr[$i]; ?>" alt=""></div>
                                    <?php } ?>
                                    <div class="employee_block info">
                            ...
                            <?php if (!empty($employee4info2Arr[$i])) { ?>
                                <div class="clearfix">
                                    <?php if ($employee4logo2Arr[$i]) { ?>
                                        <div class="employee_block logo"><img
                                                    src="<?php echo $employee4logo2Arr[$i]; ?>" alt=""></div>
                                    <?php } ?>
                                    <div class="employee_block info">
                            ...
                            <?php if (!empty($employee4info3Arr[$i])) { ?>
                                <div class="clearfix">
                                    <?php if ($employee4logo3Arr[$i]) { ?>
                                        <div class="employee_block logo"><img
                                                    src="<?php echo $employee4logo3Arr[$i]; ?>" alt=""></div>
                                    <?php } ?>
                                    <div class="employee_block info">
                            ...
                            <?php if (!empty($employee5info1Arr[$i])) { ?>
                                <div class="clearfix">
                                    <?php if ($employee5logo1Arr[$i]) { ?>
                                        <div class="employee_block logo"><img
                                                    src="<?php echo $employee5logo1Arr[$i]; ?>" alt=""></div>
                                    <?php } ?>
                                    <div class="employee_block info">
                            ...
                            <?php if (!empty($employee5info2Arr[$i])) { ?>
                                <div class="clearfix">
                                    <?php if ($employee5logo2Arr[$i]) { ?>
                                        <div class="employee_block logo"><img
                                                    src="<?php echo $employee5logo2Arr[$i]; ?>" alt=""></div>
                                    <?php } ?>
                                    <div class="employee_block info">
                            ...
                            <?php if (!empty($employee5info3Arr[$i])) { ?>
                                <div class="clearfix">
                                    <?php if ($employee5logo3Arr[$i]) { ?>
                                        <div class="employee_block logo"><img
                                                    src="<?php echo $employee5logo3Arr[$i]; ?>" alt=""></div>
                                    <?php } ?>
                                    <div class="employee_block info">
                            ...
                            <?php if (!empty($employee6info1Arr[$i])) { ?>
                                <div class="clearfix">
                                    <?php if ($employee6logo1Arr[$i]) { ?>
                                        <div class="employee_block logo"><img
                                                    src="<?php echo $employee6logo1Arr[$i]; ?>" alt=""></div>
                                    <?php } ?>
                                    <div class="employee_block info">
                            ...
                            <?php if (!empty($employee6info2Arr[$i])) { ?>
                                <div class="clearfix">
                                    <?php if ($employee6logo2Arr[$i]) { ?>
                                        <div class="employee_block logo"><img
                                                    src="<?php echo $employee6logo2Arr[$i]; ?>" alt=""></div>
                                    <?php } ?>
                                    <div class="employee_block info">
                            ...
                            <?php if (!empty($employee6info3Arr[$i])) { ?>
                                <div class="clearfix">
                                    <?php if ($employee6logo3Arr[$i]) { ?>
                                        <div class="employee_block logo"><img
                                                    src="<?php echo $employee6logo3Arr[$i]; ?>" alt=""></div>
                                    <?php } ?>
                                    <div class="employee_block info">
