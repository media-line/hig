...
<?php if (isset($this->item->images)) { ?>
	<div class="blog_intro blog_intro_image clearfix">
		<?php echo JLayoutHelper::render('intro_image', $this->item, $basePath); ?>
	</div>
<?php } ?>

<div class="blog_intro blog_intro_desc">
